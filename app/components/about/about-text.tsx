  ...
  return (
    <div className="space-y-3 font-secondary text-base text-secondary-foreground text-justify leading-6 tracking-tight md:text-xl xl:text-2xl xl:text-center">
      ...
      <p>
        ...
        <span className="text-typewriter">optimized solutions</span> for complex problems.
        I am actively seeking opportunities to apply my{" "}
        <span className="text-typewriter">analytical and coding expertise</span> in real-world scenarios.
      </p>
    </div>
  );
}
